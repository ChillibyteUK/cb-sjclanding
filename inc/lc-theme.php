...
function widgets_init()
{
    // register_sidebar(
    //     array(
    //         'name'          => __('Footer Col 1', 'cb-sjclanding'),
    //         'id'            => 'footer-1',
    //         'description'   => __('Footer Col 1', 'cb-sjclanding'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-sjclanding'),
        'footer_menu1' => __('Footer Menu 1', 'cb-sjclanding'),
        //     'footer_menu2' => __('Footer Menu 2', 'cb-sjclanding'),
    ));
